						...
						<div class="row">
	                        ...
	                        <div class="col-xs-12 col-sm-12 col-lg-12 text-day">
								...
								<div id="subscribe" class="animated-middle opacity-0">
					                ...
					                <form action="//satelimportadores.us11.list-manage.com/subscribe/post?u=cafd1f30e08a1f98069bd8e4a&amp;id=0ab3d7d795" id="notifyMe" method="POST" name="mc-embedded-subscribe-form">
					                    ...
					                    <div class="form-group">
					                        ...
					                        <div class="controls">
					                        	...
					                        	<!-- Field  -->
					                        	<input type="text" id="mce-EMAIL" name="email" placeholder="Write your email to stay tuned!" class="form-control email srequiredField" />
